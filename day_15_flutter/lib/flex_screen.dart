...
class FlexScreen extends StatelessWidget {
  ...
  Widget _buildExpanded(BuildContext context) {
    ...
    child: Row(
      children: [
        ...
        Expanded(child: LabeledContainer(color: Colors.purple, text: 'The Remainder',
  ...
  Widget _buildFlexible(BuildContext context) {
    ...
    child: Row(
      children: [
        Flexible(child: LabeledContainer(color: Colors.deepOrange, text: '25%'), flex: 1,),
        Flexible(child: LabeledContainer(color: Colors.deepOrange, text: '25%'), flex: 1,),
        Flexible(child: LabeledContainer(color: Colors.blue, text: '50%'), flex: 2,)
  ...
  Widget _buildFooter(BuildContext context) {
    return Center(
      child: Container(
        ...
        child: Padding(padding: EdgeInsets.symmetric(vertical: 15.0, horizontal: 30),
